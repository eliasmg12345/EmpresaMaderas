...
<body>
  ...
  <!--portada productos-->
  <div class="fluid">
    <img src="img/formRegistro.jpg" class="img-fluid">
  </div>
                ...
                <form class="form-horizontal" action="php/signup.php" method="post">
                  ...
                  <fieldset class="mt-5">
                    <div class="form-group">
                      <span class="col-md-1 col-md-offset-2 text-center"><i class="bi bi-123"></i></span>
                      <div class="col-md-10">
                        <input id="ci" name="ci" type="text" placeholder="Cédula de Identidad" class="form-control" required>
                      </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      <span class="col-md-1 col-md-offset-2 text-center"><i class="bi bi-person-circle"></i></span>
                      <div class="col-md-10">
                        <input id="ape_paterno" name="ape_paterno" type="text" placeholder="Apellido Paterno" class="form-control" required>
                      </div>
                    </div>
                    <div class="form-group">
                      <span class="col-md-1 col-md-offset-2 text-center"><i class="bi bi-person-circle"></i></span>
                      <div class="col-md-10">
                        <input id="ape_materno" name="ape_materno" type="text" placeholder="Apellido Materno" class="form-control" required>
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-10">
                        <input id="correo" name="correo" type="email" placeholder="Correo Electronico" class="form-control" required>
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-10">
                        <input id="telefono" name="telefono" type="text" placeholder="Celular" class="form-control" required>
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      <span class="col-md-1 col-md-offset-2 text-center"><i class="bi bi-lock-fill"></i></span>
                      <div class="col-md-10">
                        <input id="confirm_password" name="confirm_password" type="password" placeholder="confirmar contraseña" class="form-control" required>
                      </div>
                    </div>

                    <div class="form-group">
                      <div class="col-md-10 text-center mb-5 mt-5">
                        <button type="submit" class="btn btn-warning btn-lg text-white"><em>Registrarse</em></button>
                      </div>
                    </div>
                  </fieldset>
                </form>
