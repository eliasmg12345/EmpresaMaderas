...
<body>
  ...
  <!--portada productos-->
  <div class="fluid">
    <img src="img/formReserva.jpg" class="img-fluid">
  </div>
  <!--fin portada productos-->
  <?php
  include "php/reservaMostrar.php";
  include "php/reserva.php";
  ?>

  <!--form-->
  <div class="container">
    <h1 class="text-center mt-5"><strong><em>Reserve su Producto</em></strong></h1>
    <div class="row">
      <div class="col">
      </div>
      <div class="col">
                ...
                <form class="form-horizontal" action="" method="post">
                  ...
                  <fieldset class="mt-5">
                    ...
                    <div class="form-group">
                      <span class="col-md-1 col-md-offset-2 text-center"><i class="bi bi-person-circle">Nombre</i></span>
                      <div class="col-md-10">

                        <input class="form-control" type="text" value="<?php echo $r1["nombre"]; ?>" aria-label="Disabled input example" disabled readonly>


                      </div>
                    </div>
                    <div class="form-group">
                      <span class="col-md-1 col-md-offset-2 text-center"><i class="bi bi-person-circle">Apellido Paterno</i></span>
                      <div class="col-md-10">
                        <input class="form-control" type="text" value="<?php echo $r1["ape_paterno"]; ?>" aria-label="Disabled input example" disabled readonly>
                      </div>
                    </div>
                    <div class="form-group">
                      <span class="col-md-1 col-md-offset-2 text-center"><i class="bi bi-person-circle">Apellido Materno</i></span>
                      <div class="col-md-10">
                        <input class="form-control" type="text" value="<?php echo $r1["ape_materno"]; ?>" aria-label="Disabled input example" disabled readonly>
                      </div>
                    </div>

                    <div class="form-group">
                      <span class="col-md-1 col-md-offset-2 text-center"><i class="bi bi-telephone-fill">Telefono</i></span>
                      <div class="col-md-10">
                        <input class="form-control" type="text" value="<?php echo $r1["telefono"]; ?>" aria-label="Disabled input example" disabled readonly>
                      </div>
                    </div>
                    <div class="form-group">
                      <span class="col-md-1 col-md-offset-2 text-center"><i class="bi bi-bag-fill">Producto</i></span>
                      <div class="col-md-10">
                        <input class="form-control" type="text" value="<?php echo $r2["Descripcion"]; ?>" aria-label="Disabled input example" disabled readonly>
                      </div>
                    </div>
                    <div class="form-group">
                      ...
                      <div class="row align-items-start">
                        ...
                        <div class="col">
                          <span class="col-md-1 col-md-offset-2 text-center"><i class="bi bi-stack">Cantidad a Reservar</i></span>
                          <div class="col-md-10 ">
                            <input id="cantidad" name="cantidad" type="text" placeholder="Cantidad" class="form-control <?php echo (isset($error['cantidad'])) ? "is-invalid" : ""; ?>" required>
                        ...
                        <div class="col">
                          ...
                          <span class="col-md-1 col-md-offset-2 text-center"><i class="bi bi-stack">Cantidad Existente</i></span>
                          <div class="col-md-10">
                            <input class="form-control" type="text" value="<?php echo $r2["Cantidad"]; ?>" aria-label="Disabled input example" disabled readonly>
                          </div>
                        </div>
                    ...
                    <div class="form-group">
                      <div class="col-md-10 text-center mb-5 mt-5">
                        <button type="submit" class="btn btn-warning btn-lg text-white"><em>Reservar</em></button>
                      </div>
                    </div>
                  </fieldset>
                </form>
